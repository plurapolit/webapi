...
ActiveRecord::Schema.define(version: 2020_01_15_182800) do
  ...
  create_table "statements", force: :cascade do |t|
    ...
    t.index ["audio_file_id"], name: "index_statements_on_audio_file_id"
  ...
  add_foreign_key "statements", "audio_files"
